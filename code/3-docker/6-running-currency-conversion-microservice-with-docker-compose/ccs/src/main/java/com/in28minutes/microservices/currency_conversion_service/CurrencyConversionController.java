...
public class CurrencyConversionController {
    ...
    public CurrencyConversion calculateCurrencyConversion(
        ...
        ResponseEntity<CurrencyConversion> responseEntity = restTemplate.getForEntity("http://192.168.1.21:8001/currency-exchange/from/{from}/to/{to}", CurrencyConversion.class, uriVariables);
