...
import com.unfaithfultechnology.data_jpa.course.springdatajpa.CourseSpringDataJpaRepository;
...
public class CourseCommandLineRunner implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        System.out.println("Course id 2 -> " + repository.findById(2L));
        System.out.println("Course id 3 -> " + repository.findById(3L));
